...
const db_informacoes_inicial = {
  data: [
    ...
    },
    {
      ...
      descricao:
        "Acessando o site, você terá informações sobre o Acidente Vascular Cerebral (AVC)",
    },
    {
      id: 3,
      acidente: "Queimadura",
      ...
      descricao:
        "Sabia que não pode passar qualquer produto em queimaduras? Compreenda o porquê",
    },
    {
      id: 4,
      acidente: "Convulsão",
    ...
    },
    {
      ...
      descricao:
        "Os vídeos mostram manobras a serem realizadas em caso de desmaio",
    },
    {
      id: 8,
      acidente: "Infarto",
      ...
      descricao:
        "Acesse os links disponídeis para prevenir e identificar o quadro de infarto",
    },
    {
      id: 9,
      acidente: "Fratura",
    ...
    },
    {
      ...
      descricao:
        "Os vídeos mostram manobras a serem realizadas em caso de convulsão",
    },
    {
      id: 12,
      acidente: "Intoxicação",
      ...
      descricao:
        "Acessando o site, você terá informações sobre intoxicação por alimentos",
    },
  ],
};

// Caso os dados já estejam no Local Storage, caso contrário, carrega os dados iniciais
const localStorageDataBase = localStorage.getItem("db_informacao");
let dataBase = JSON.parse(localStorageDataBase);
if (!dataBase) {
  dataBase = db_informacoes_inicial;
}
...
function insertInformacao({
  ...
  let novoId = 1;
  const dataBaseLength = db.data.length;
  const hasItemInDataBase = dataBaseLength != 0;

  const finalIndex = dataBaseLength - 1;

  if (hasItemInDataBase) novoId = db.data[finalIndex].id + 1;
